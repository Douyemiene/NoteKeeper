...
public class DataManager {
    ...
    public int findNote(com.jwhh.jim.notekeeper.NoteInfo note) {
    ...
    public List<com.jwhh.jim.notekeeper.CourseInfo> getCourses() {
        return mCourses;
    }

    public com.jwhh.jim.notekeeper.CourseInfo getCourse(String id) {
        for (com.jwhh.jim.notekeeper.CourseInfo course : mCourses) {
    ...
    public List<com.jwhh.jim.notekeeper.NoteInfo> getNotes(com.jwhh.jim.notekeeper.CourseInfo course) {
        ArrayList<com.jwhh.jim.notekeeper.NoteInfo> notes = new ArrayList<>();
        for(com.jwhh.jim.notekeeper.NoteInfo note:mNotes) {
